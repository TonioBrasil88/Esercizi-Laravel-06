<x-layout>
    ...
    <img style="background: url('.//media/ciak.png')">
                ...
                <div class="row my-5">
                    <div class="col-12 col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="genre" value="{{ old('genre') }}" @error('genre') @enderror class="form-control">
                                @error('genre')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="released_at" value="{{ old('released_at') }}" class="form-control">
                            </div>
                            <div class="mb-3">
